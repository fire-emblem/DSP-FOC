...
#define Pwm_EN_0 GpioDataRegs.GPDCLEAR.bit.GPIOD6=1;
#define Pwm_EN_1 GpioDataRegs.GPDSET.bit.GPIOD6=1;
#define DC_ON_0 GpioDataRegs.GPACLEAR.bit.GPIOA11=1;
#define DC_ON_1 GpioDataRegs.GPASET.bit.GPIOA11=1;
extern void CPU_RUN(void);
extern void IPM_BaoHu(void);
extern Uint16 IPM_Fault;
extern void eva_close(void);
extern void eva_open(void);

extern _iq Speed_Ui;
extern _iq IQ_Ui;
extern _iq ID_Ui;
extern Uint16 LocationFlag;
extern Uint16 Position;
extern float32 j;
extern float32 Modulation;
extern _iq IQ_Given;
extern float32 SpeedRef;
extern _iq OldRawTheta;
extern Uint16 speed_give;
extern _iq Speed_SatError;
extern _iq IQ_SatError;
extern _iq ID_SatError;
extern  int32 PosCount;
extern _iq OldRawThetaPos;
extern Uint16 Hall_Fault;
extern Uint16 HallAngle;
