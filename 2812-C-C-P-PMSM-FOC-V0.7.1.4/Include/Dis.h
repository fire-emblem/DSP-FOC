...
//
extern void Init_DIs_Gpio(void);
...
#define SCL_0 GpioDataRegs.GPBCLEAR.bit.GPIOB5=1;
#define SCL_1 GpioDataRegs.GPBSET.bit.GPIOB5=1;

#define SDL_0 GpioDataRegs.GPBCLEAR.bit.GPIOB4=1;
#define SDL_1 GpioDataRegs.GPBSET.bit.GPIOB4=1;
 

extern void ch454_write(Uint16 cmd);
extern Uint16 mBCD[20];
extern void Read_key(void);
extern void Init_ch454(void);
extern void Dis_Show(void);
extern void deal_key(void);
extern Uint16 Show_time;
extern Uint16 ZhengFan;
extern Uint16 Show_time2;
extern Uint16 KEY_Type;
