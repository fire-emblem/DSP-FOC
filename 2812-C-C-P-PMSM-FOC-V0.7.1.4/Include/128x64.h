...
#define SCL_LCD_0 GpioDataRegs.GPBCLEAR.bit.GPIOB6=1;
#define SCL_LCD_1 GpioDataRegs.GPBSET.bit.GPIOB6=1;

#define SDL_LCD_0 GpioDataRegs.GPBCLEAR.bit.GPIOB7=1;
#define SDL_LCD_1 GpioDataRegs.GPBSET.bit.GPIOB7=1;
